...
# Create Network Security Groups for Teams & PSTN Interfaces
    ...
    $TeamsRule2 = New-AzNetworkSecurityRuleConfig -Name Media_Ports -Description "Media Ports" -Access Allow -Protocol Udp -Direction Inbound -Priority 101 -SourceAddressPrefix 52.112.0.0/14 -SourcePortRange 10000-15999,49152-53247 -DestinationAddressPrefix * -DestinationPortRange 10000-15999
