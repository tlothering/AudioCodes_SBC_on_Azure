...
# Create Network Security Groups for Teams & PSTN Interfaces
    ...
    $TeamsRule2 = New-AzNetworkSecurityRuleConfig -Name Media_Ports -Description "Media Ports" -Access Allow -Protocol Udp -Direction Inbound -Priority 101 -SourceAddressPrefix 52.112.0.0/14,52.120.0.0/14 -SourcePortRange 3478-3481,49152-59999 -DestinationAddressPrefix * -DestinationPortRange 6000-6499
